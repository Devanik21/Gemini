...
with col1:
    input_type = st.selectbox("+", ["Text", "Files"], 
...
if input_type == "Text":
    user_input = st.chat_input("Ask a question or continue chatting...", key="text_input")
...
if input_type == "Text" or file_processed:
    ...
    query = st.chat_input("Ask about your file or continue chatting...", key="follow_up_input")
